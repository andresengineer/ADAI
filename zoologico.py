...
'''
    ...
    count_animals_values = list(contador_apariciones.values())
    max_animal = encontrar_valor_maximo(count_animals_values)
    min_animal = encontrar_valor_minimo(count_animals_values)

    max_animals = []
    min_animals = []
    for animal in contador_apariciones:
        value = contador_apariciones[animal]
        if value == max_animal:
